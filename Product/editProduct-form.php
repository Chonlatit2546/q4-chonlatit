...
<body>
   ...
   <main>
      <article>
         ...
         <form action="editProduct_db.php" method="post" enctype="multipart/form-data" style="display:flex;flex-direction: column;gap:2px;">
            ...
            <label for="pdetail">รายละเอียด:</label>
            <input type="text" name="pdetail" value="<?= $row["pdetail"] ?>">
            <br>
