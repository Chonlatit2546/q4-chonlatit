...
<body>
   ...
   <main>
      <article>
         ...
         <form action="./editMember_db.php" method="post" enctype="multipart/form-data" style="display:flex;flex-direction: column;gap:2px;">
            ...
            <input type="tel" name="mobile" value="<?= $row["mobile"] ?>">
            <br>
